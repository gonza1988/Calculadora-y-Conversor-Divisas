...
public class VentanaDivisas extends javax.swing.JFrame {
    ...
    private void obtenerDinero() {
        ...
        etiquetaCambio2.setText(String.format("%.4f", dinero));
    }

    private void cambioDivisas() {
        if (divisa1.equals(divisa2)) {
            cambio = 1;
        } else if (divisa1.equals("Estados Unidos - Dólar") && divisa2.equals("Argentina - Peso")) {
            cambio = 740;
        } else if (divisa1.equals("Estados Unidos - Dólar") && divisa2.equals("Europa - Euro")) {
            cambio = 0.92;
        } else if (divisa1.equals("Argentina - Peso") && divisa2.equals("Estados Unidos - Dólar")) {
            cambio = 0.001352;
        } else if (divisa1.equals("Argentina - Peso") && divisa2.equals("Europa - Euro")) {
            cambio = 0.001245;
        } else if (divisa1.equals("Europa - Euro") && divisa2.equals("Estados Unidos - Dólar")) {
            cambio = 1.09;
        } else if (divisa1.equals("Europa - Euro") && divisa2.equals("Argentina - Peso")) {
            cambio = 804;
        }
    }
